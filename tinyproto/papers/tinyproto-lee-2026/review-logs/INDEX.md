...
Đây là **log thô**. Kết luận đã tổng hợp ở [`../tests.md`](../../../docs/tests.md); đừng suy luận
...
Kết luận và hướng xử lý ở [`../production-review.md`](../../../docs/production-review.md), CONTEXT §8.
