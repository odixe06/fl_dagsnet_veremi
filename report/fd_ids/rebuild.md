...
[`../papers/fd-ids-2025/proj/`](../../fd_ids/papers/fd-ids-2025/proj). Nhật ký đầy đủ từng phiên:
[`../CONTEXT.md`](../../fd_ids/CONTEXT.md); mọi số đo: [`tests.md`](../../fd_ids/docs/tests.md); kết quả: [`report.md`](report.md).
