...
Ngày lập: 2026-09-15, hoàn tất 2026-09-16. Nguồn số liệu: [`report_data/`](../../pfedes/papers/pfedes-yi-2025/report_data) (sinh bởi
[`scripts/report_data.py`](../../pfedes/scripts/report_data.py) từ artifact đã kéo về và verify local; không có số nào
...
**Cơ chế được dựng lại đầy đủ** (Eq. (4)–(11), [`proj/pfedes.py`](../../pfedes/papers/pfedes-yi-2025/proj/pfedes.py)):
...
Số đo thật từ [`knowledge/dataset.md`](../../pfedes/knowledge/dataset.md) (audit 2026-09-07), không chép từ README.
...
![f1_macro và accuracy (mean ± std trên client) theo round; lịch LR](../../pfedes/papers/pfedes-yi-2025/report_data/convergence.png)
...
![Phân bố f1_macro theo client ở round cuối](../../pfedes/papers/pfedes-yi-2025/report_data/client_spread.png)
...
![F1 từng lớp 20c](../../pfedes/papers/pfedes-yi-2025/report_data/per_class_f1_20c.png)
![F1 từng lớp 50c](../../pfedes/papers/pfedes-yi-2025/report_data/per_class_f1_50c.png)
![F1 từng lớp 100c](../../pfedes/papers/pfedes-yi-2025/report_data/per_class_f1_100c.png)

![Confusion gộp 20c, chuẩn hoá theo hàng](../../pfedes/papers/pfedes-yi-2025/report_data/confusion_20c.png)
![Confusion gộp 50c, chuẩn hoá theo hàng](../../pfedes/papers/pfedes-yi-2025/report_data/confusion_50c.png)
![Confusion gộp 100c, chuẩn hoá theo hàng](../../pfedes/papers/pfedes-yi-2025/report_data/confusion_100c.png)
...
![Phút train / eval mỗi round](../../pfedes/papers/pfedes-yi-2025/report_data/round_time.png)
...
[`proj/`](../../pfedes/papers/pfedes-yi-2025/proj) (8 module); notebook đã thực thi của từng phiên nằm trong `logs/sessions/<n>/executed.ipynb`.
