...
chứng (local, probe 2×T4, production) được trình bày ở [`TESTS.md`](../../perfedskd/docs/TESTS.md).
...
* Caveat của dữ liệu ([`knowledge/DATASET.md` §6](../../perfedskd/knowledge/DATASET.md)):
...
![client_spread](../../perfedskd/papers/perfedskd-singh-2025/report_data/client_spread.png)
...
![convergence](../../perfedskd/papers/perfedskd-singh-2025/report_data/convergence.png)
...
![selection](../../perfedskd/papers/perfedskd-singh-2025/report_data/selection.png)
...
![per_class_f1_20c](../../perfedskd/papers/perfedskd-singh-2025/report_data/per_class_f1_20c.png)

![per_class_f1_50c](../../perfedskd/papers/perfedskd-singh-2025/report_data/per_class_f1_50c.png)

![per_class_f1_100c](../../perfedskd/papers/perfedskd-singh-2025/report_data/per_class_f1_100c.png)

![confusion_20c](../../perfedskd/papers/perfedskd-singh-2025/report_data/confusion_20c.png)

![confusion_50c](../../perfedskd/papers/perfedskd-singh-2025/report_data/confusion_50c.png)

![confusion_100c](../../perfedskd/papers/perfedskd-singh-2025/report_data/confusion_100c.png)
...
![skd_loss](../../perfedskd/papers/perfedskd-singh-2025/report_data/skd_loss.png)
...
**Số bước AMP bị skip mỗi round cũng tăng.** Đây là mẫu hình mà [`KAGGLE.md` §6](../../perfedskd/docs/KAGGLE.md) liệt
...
Nguồn: [`TESTS.md` §4](../../perfedskd/docs/TESTS.md). Cả hai probe báo `compiled/compiled`. Bước SKD compiled đạt
...
![round_time](../../perfedskd/papers/perfedskd-singh-2025/report_data/round_time.png)
...
`verify_run.py` dựng lại **mọi** con số từ artifact ([`TESTS.md` §3.5](../../perfedskd/docs/TESTS.md)):
