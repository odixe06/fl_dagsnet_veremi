...
Nguồn số liệu: [`report_data/`](../papers/nilm-li-2024/report_data) (sinh bởi [`scripts/report_data.py`](../scripts/report_data.py) từ
...
**Cơ chế được dựng lại đầy đủ** ([`proj/nilm.py`](../papers/nilm-li-2024/proj/nilm.py), trích xuất ở [`paper.md`](paper.md) §3):
...
![f1_macro và accuracy: w_s mean ± std trên client (nét liền), proxy w̄_r (nét đứt); lịch LR](../papers/nilm-li-2024/report_data/convergence.png)
...
![Phân bố f1_macro theo client ở round 50; vạch tím = proxy w̄_r](../papers/nilm-li-2024/report_data/client_spread.png)
...
![F1 từng lớp 20c](../papers/nilm-li-2024/report_data/per_class_f1_20c.png)
![F1 từng lớp 50c](../papers/nilm-li-2024/report_data/per_class_f1_50c.png)
![F1 từng lớp 100c](../papers/nilm-li-2024/report_data/per_class_f1_100c.png)

![Confusion gộp 20c, chuẩn hoá theo hàng](../papers/nilm-li-2024/report_data/confusion_20c.png)
![Confusion gộp 50c, chuẩn hoá theo hàng](../papers/nilm-li-2024/report_data/confusion_50c.png)
![Confusion gộp 100c, chuẩn hoá theo hàng](../papers/nilm-li-2024/report_data/confusion_100c.png)
...
![Phút train / eval mỗi round](../papers/nilm-li-2024/report_data/round_time.png)
...
![ce_s, ce_r, kl_s, kl_r trung bình client theo round](../papers/nilm-li-2024/report_data/mutual_loss.png)
...
NvidiaTeslaT4, `docker_image` pin theo digest. Mã nguồn duy nhất của notebook: [`proj/`](../papers/nilm-li-2024/proj) (8 module); test
local: `rebuild.md` §5.
