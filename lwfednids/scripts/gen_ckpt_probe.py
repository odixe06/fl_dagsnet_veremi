...
resume gate (proj/ckpt.py, embedded byte-for-byte) will see it, up to the expected round?
    ...
    python scripts/gen_ckpt_probe.py --owner minhtran0601 --dataset minhtran0601/lwfednids-20c-ckpt-s1 \
        --run-name lwfednids_20c --expect-round 33 --out papers/lwfednids-bouayad-2024/notebook/20c_ckpt_probe
...
ROOT = Path(__file__).resolve().parents[1] / "papers/lwfednids-bouayad-2024"
