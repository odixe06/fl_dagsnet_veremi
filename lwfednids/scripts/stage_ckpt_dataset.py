...
resume route.
    ...
    python scripts/stage_ckpt_dataset.py papers/lwfednids-bouayad-2024/runs/pulls/20c_s1/runs/lwfednids_20c \\
        --owner minhtran0601 --slug lwfednids-20c-ckpt-s1 --out papers/lwfednids-bouayad-2024/runs/ckpt_ds/20c_s1
