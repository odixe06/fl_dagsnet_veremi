#!/usr/bin/env python
"""Poll W&B (and optionally the Kaggle kernel status) for the production Lightweight-Fed-NIDS runs.

    python scripts/watch_prod.py lwfednids_20c lwfednids_50c lwfednids_100c
...
COLS = ("f1_macro", "accuracy", "f1_weighted", "lr", "loss_client_mean", "loss_client_std",
        "gnorm_client_mean", "skipped", "steps", "train_sec", "eval_sec", "seconds",
        "vram_train_gb")
...
def main():
    ...
    ap.add_argument("--project", default="21522798-uit/lwfednids-veremi")
