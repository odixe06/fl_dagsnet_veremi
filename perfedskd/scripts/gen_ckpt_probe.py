...
resume gate (proj/ckpt.py, embedded byte-for-byte) will see it, up to the expected round?
    ...
    python scripts/gen_ckpt_probe.py --owner minhtrit06 --dataset minhtrit06/perfedskd-20c-ckpt-s1 \
        --run-name perfedskd_20c --expect-round 33 --out papers/perfedskd-singh-2025/notebook/20c_ckpt_probe
...
ROOT = Path(__file__).resolve().parents[1] / "papers/perfedskd-singh-2025"
