...
resume route.
    ...
    python scripts/stage_ckpt_dataset.py papers/perfedskd-singh-2025/runs/pulls/20c_s1/runs/perfedskd_20c \\
        --owner minhtrit06 --slug perfedskd-20c-ckpt-s1 --out papers/perfedskd-singh-2025/runs/ckpt_ds/20c_s1
